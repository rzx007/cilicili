...
import 'package:cilicili/components/showSheet.dart';

class ListItemView extends StatefulWidget {
  final Widget jumpWiget;
  ListItemView({Key key, this.jumpWiget}) : super(key: key);
...
class _ListItemViewState extends State<ListItemView> {
  ...
  Widget _textBlock(context) {
    return Material(
      ...
      child: InkWell(
        borderRadius: BorderRadius.vertical(bottom: Radius.elliptical(6, 6)),
        onTap: () {},
        child: Container(
          decoration: BoxDecoration(
            borderRadius:
