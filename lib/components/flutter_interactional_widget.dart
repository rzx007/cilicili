...
class InteractionalWidget extends StatefulWidget {
  ...
  @override
  State<InteractionalWidget> createState() => _InteractionalWidgetState();
}
        ...
        children: [
          Positioned(
              ...
              child: Transform.scale(
                  ...
                  child: widget.backgroundWidget ?? const Row())),
          Positioned(
              child: Transform.scale(
                  scale: widget.middleScale ?? 1.0,
                  child: widget.middleWidget ?? const Row())),
          Positioned(
              top: foregroundOffset.dy,
              left: foregroundOffset.dx,
              child: Transform.scale(
                  scale: widget.foregroundScale ?? 1.0,
                  child: widget.foregroundWidget ?? const Row()))
        ],
      ),
    );
  }
